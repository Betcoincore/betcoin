...
#define START_MASTERNODE_PAYMENTS 1530378000 //date -d "2018-07-01" +"%s" date -d @1530378000// myfix for masternode 

static const int64_t DARKSEND_COLLATERAL = (0.01*COIN);
static const int64_t DARKSEND_POOL_MAX = (4999.99*COIN);

static const int64_t STATIC_POS_REWARD = 30 * COIN; //Constant reward of 30 BET per COIN.
...
static const int64_t MAX_MONEY = 200000000 * COIN;  // 200M COIN
...
public:
	...
	{
		if (nTime < 1525263000) {//Wed May  2 19:10:00 WIB 2018
