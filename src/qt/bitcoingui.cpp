    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Bet Core") + " - ";
    //windowTitle = tr("Goldrium") + " - "; 
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Bet address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bet: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Bet Core"), this);
    aboutAction->setStatusTip(tr("Show information about Bet Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Bet Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Bet addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Bet addresses"));
    ...
    openAction->setStatusTip(tr("Open a bet: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Bet Core help message to get a list with possible Bet Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Bet Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Bet Core"); // default title
