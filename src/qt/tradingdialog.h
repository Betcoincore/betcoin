...
private slots:
    ...
    QString BuyBET(QString OrderType, double Quantity, double Rate);
    QString SellBET(QString OrderType, double Quantity, double Rate);
