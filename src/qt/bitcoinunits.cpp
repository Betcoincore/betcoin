...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("BET");
    case mBTC: return QString("mBET");
    case uBTC: return QString::fromUtf8("μBET");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Bets");
    case mBTC: return QString("Milli-Bets (1 / 1,000)");
    case uBTC: return QString("Micro-Bets (1 / 1,000,000)");
    default: return QString("???");
    }
}
