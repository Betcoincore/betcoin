...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total bet balance of the wallet\n"
            "  \"privatesend_balance\": xxxxxx, (numeric) the anonymized bet balance of the wallet\n"
...
UniValue debug(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "bet|privatesend|instantsend|masternode|spork|keepass|mnpayments|gobject )\n"
            "Change debug category on the fly. Specify single category or use comma to specify many.\n"
            "\nExamples:\n"
            + HelpExampleCli("debug", "bet")
            + HelpExampleRpc("debug", "bet,net")
        );
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"betaddress\"\n"
            "\nReturn information about the given bet address.\n"
            "\nArguments:\n"
            "1. \"betaddress\"     (string, required) The bet address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"betaddress\", (string) The bet address validated\n"
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("validateaddress", "\"bW5JJT2cDJG2fMvnfJoS5c7n5XaoRFC8dg\"")
            + HelpExampleRpc("validateaddress", "\"bW5JJT2cDJG2fMvnfJoS5c7n5XaoRFC8dg\"")
        );
...
#ifdef ENABLE_WALLET
        // Case 1: Bet address and we have full public key:
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "2. \"keys\"       (string, required) A json array of keys which are bet addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) bet address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"betaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"betaddress\"  (string, required) The bet address to use for the signature.\n"
            ...
            "\nAs json rpc\n"
            + HelpExampleRpc("verifymessage", "\"bW5JJT2cDJG2fMvnfJoS5c7n5XaoRFC8dg\", \"signature\", \"my message\"")
        );
...
UniValue getaddressmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressmempool", "'{\"addresses\": [\"bW5JJT2cDJG2fMvnfJoS5c7n5XaoRFC8dg\"]}'")
            + HelpExampleRpc("getaddressmempool", "{\"addresses\": [\"bW5JJT2cDJG2fMvnfJoS5c7n5XaoRFC8dg\"]}")
        );
...
UniValue getaddressutxos(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressutxos", "'{\"addresses\": [\"bW5JJT2cDJG2fMvnfJoS5c7n5XaoRFC8dg\"]}'")
            + HelpExampleRpc("getaddressutxos", "{\"addresses\": [\"bW5JJT2cDJG2fMvnfJoS5c7n5XaoRFC8dg\"]}")
        );
...
UniValue getaddressdeltas(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1 || !params[0].isObject())
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressdeltas", "'{\"addresses\": [\"bW5JJT2cDJG2fMvnfJoS5c7n5XaoRFC8dg\"]}'")
            + HelpExampleRpc("getaddressdeltas", "{\"addresses\": [\"bW5JJT2cDJG2fMvnfJoS5c7n5XaoRFC8dg\"]}")
        );
...
UniValue getaddressbalance(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressbalance", "'{\"addresses\": [\"bW5JJT2cDJG2fMvnfJoS5c7n5XaoRFC8dg\"]}'")
            + HelpExampleRpc("getaddressbalance", "{\"addresses\": [\"bW5JJT2cDJG2fMvnfJoS5c7n5XaoRFC8dg\"]}")
        );
...
UniValue getaddresstxids(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddresstxids", "'{\"addresses\": [\"bW5JJT2cDJG2fMvnfJoS5c7n5XaoRFC8dg\"]}'")
            + HelpExampleRpc("getaddresstxids", "{\"addresses\": [\"bW5JJT2cDJG2fMvnfJoS5c7n5XaoRFC8dg\"]}")
        );
