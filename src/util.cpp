...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Bet
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Bet
    // Mac: ~/Library/Application Support/Bet
    // Unix: ~/.Bet
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Bet";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Bet.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "Betd.pid"));
